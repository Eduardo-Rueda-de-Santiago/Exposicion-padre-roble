...
class RemixEngine:
    def __init__(
        ...
        if not sf or not sd:
            print(
                "[AudioService] sounddevice or soundfile not installed. Audio disabled."
            )
            self.n_tracks = 0
            return
        ...
        try:
            ...
            for sensor_id, data in sensors.items():
                ...
                if os.path.exists(audio_file):
                    ...
                    print(
                        f"[AudioService] Warning: Audio file {audio_file} for {sensor_id} not found."
                    )
            print(self.sensor_to_track_idx)
